...
/** How the training programs overview is laid out: a dense table or a card grid. */
export type ProgramsView = 'table' | 'grid';

const KEY = 'training.programs.view';
const ALLOWED: readonly ProgramsView[] = ['table', 'grid'];

/**
 * Remembers whether the admin prefers the table or card layout for training
