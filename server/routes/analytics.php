...
| Attrition Risk flags employees likely to leave; Promotion Readiness scores every
| active employee for advancement; Performance Forecast projects each one's
| next-period rating. Runs are addressed by hashid. Viewing needs the surface's
| `*.view` permission; triggering or deleting a run needs its `*.manage` permission.
*/
