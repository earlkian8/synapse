...
/**
 * File a leave request from the mobile app. Unlike the web
 * {@see StoreLeaveRequestRequest}, the employee is never
 * supplied by the client — the controller forces it to the signed-in account's
 * own record. The chargeable `days` are likewise computed server-side; a half day
 * is only valid for a single-day request whose type permits it.
 */
class StoreLeaveRequest extends FormRequest
{
    ...
    /**
     * The validated date payload, with `half_day_period` cleared when not a half day.
     *
